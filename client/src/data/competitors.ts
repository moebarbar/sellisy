...
export const COMPETITORS: Competitor[] = [
...

  {
    ...
    rows: COMMON_ROWS([
      ...
      { label: "Subscription products", sellisy: "Yes (via Stripe)", competitor: "Yes", winner: "tie" },
      { label: "Email marketing", sellisy: "Newsletter campaigns", competitor: "Built-in", winner: "tie" },
...

  {
    ...
    rows: COMMON_ROWS([
      ...
      { label: "PLR / MRR library", sellisy: "Hundreds, included", competitor: "Not included", winner: "sellisy" },
      { label: "AI creator tools", sellisy: "Built-in", competitor: "Not included", winner: "sellisy" },
      { label: "Memberships / subscriptions", sellisy: "Yes (via Stripe)", competitor: "Yes", winner: "tie" },
      { label: "Software license keys", sellisy: "Yes", competitor: "No", winner: "sellisy" },
...

  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Sellisy has newsletter campaigns; full marketing automation isn't its focus today. Most creators on Sellisy use Resend / ConvertKit / similar for advanced automation.",
      },
    ],
  },

  {
    ...
    rows: COMMON_ROWS([
      ...
      { label: "Email marketing", sellisy: "Newsletter campaigns", competitor: "Yes (their core)", winner: "competitor" },
      ...
      { label: "Software license keys", sellisy: "Yes", competitor: "No", winner: "sellisy" },
      { label: "Multi-store / brands", sellisy: "Up to unlimited", competitor: "Single account", winner: "sellisy" },
      { label: "Email automation", sellisy: "Basic", competitor: "Advanced (visual sequences)", winner: "competitor" },
