  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {bundlesLoading ? (
        ...
        <CrewEmptyState
          eyebrow="No bundles yet"
          title="Bundle up for bigger wins"
          description="Group products into irresistible bundles at a discount and watch your average order value climb."
          accent="#FF6B35"
          action={
