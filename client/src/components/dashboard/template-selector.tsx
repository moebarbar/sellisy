...
const TEMPLATES: TemplateOption[] = [
  ...
  },
  {
    key: "launchpad",
    name: "Launchpad",
    subtitle: "Single-product sales page",
    icon: Rocket,
    preview: {
      bg: "#08090b",
      accent: "#10b981",
      ...
      textColor: "#f9fafb",
      textMuted: "rgba(249,250,251,0.55)",
      heroBg: "radial-gradient(ellipse at 50% 0%, rgba(16,185,129,0.14), transparent 65%), #08090b",
      headerBg: "rgba(8,9,11,0.95)",
